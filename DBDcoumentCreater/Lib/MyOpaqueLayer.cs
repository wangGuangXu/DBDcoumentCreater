...
namespace Core.Ext
{
    public static partial class ExtendMethod
    {
        ...
        private static void EnabledTabIndex(Control control, bool enabled)
        {
            foreach (Control c in control.Controls)
            {
                c.TabStop = enabled;
                EnabledTabIndex(c, enabled);
            }
        }
        ...
        /// 隐藏遮罩层
        /// </summary>
        public static void CloseLoading(this Control control)
        {
            try
            {
                if (m_OpaqueLayer != null)
